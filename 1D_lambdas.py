# Code for automated computations for different lambdas
...
number_for_comparison = 51
number_for_scaling = 0.06
...
for i in range(1, number_for_comparison):
    ...
    for j in range(number_for_averaging):
        ...
        # Step 2i: Run the accelerated double-phase adaptive ROF
...
# Code to start the plot from the first non-zero λ

lambda_values = [number_for_scaling * i for i in range(1, number_for_comparison)]
plt.plot(lambda_values, average_ROF_acc[1:], label="ROF")
plt.plot(lambda_values, average_mROF[1:], label="dpROF")
