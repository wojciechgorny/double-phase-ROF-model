# Code for automated computations for the graphs in terms of the L2 distance from the noisy image
...
# Definitions of several test functions with parameters
...
test_function_labels = {
    ...
    linear_function: "lin",
    zero_function: "zero",
    characteristic_function_interval: "interval",
    step_function: "smalljump",
    square_zero: "square-zero",
    square: "square",
    square_linear: "square-linear"
    }
...
# Spacing of lambdas and number of tested values

number_for_comparison = 100
number_for_scaling = 0.05

# Parameter in Huber-ROF
...
for i in range(1, number_for_comparison):
    ...
    for j in range(number_for_averaging):
        ...
        # Step 3i-2: Run accelerated classical ROF
        ...
        # Step 3i-1: Run the accelerated double-phase adaptive ROF
        ...
        # Step 3i: Run the accelerated Huber ROF
...
# Plots with L2 distance from noisy

# Create auxiliary variables for the x-axis
...
plt.title(
    ...
    f"σ = {current_noise}, Image: {filename}"
)
plt.grid(True)
plt.legend()
#plt.xlim(left=0)
